...
func init() {
	...
	proto.RegisterType((*ClusterNetworkEntry)(nil), "github.com.openshift.origin.pkg.sdn.api.v1.ClusterNetworkEntry")
...
func (m *ClusterNetwork) MarshalTo(data []byte) (int, error) {
	...
	if len(m.ClusterDef) > 0 {
		for _, msg := range m.ClusterDef {
			data[i] = 0x32
			i++
...
func (m *ClusterNetworkEntry) MarshalTo(data []byte) (int, error) {
	...
	data[i] = 0xa
	i++
	i = encodeVarintGenerated(data, i, uint64(len(m.ClusterNetworkCIDR)))
	i += copy(data[i:], m.ClusterNetworkCIDR)
	return i, nil
}
...
func (this *ClusterNetwork) String() string {
	...
	s := strings.Join([]string{`&ClusterNetwork{`,
		...
		`ClusterDef:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.ClusterDef), "ClusterNetworkEntry", "ClusterNetworkEntry", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ClusterNetworkEntry) String() string {
	...
	s := strings.Join([]string{`&ClusterNetworkEntry{`,
		`ClusterNetworkCIDR:` + fmt.Sprintf("%v", this.ClusterNetworkCIDR) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *ClusterNetwork) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.ClusterDef = append(m.ClusterDef, ClusterNetworkEntry{})
			if err := m.ClusterDef[len(m.ClusterDef)-1].Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ClusterNetworkEntry) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ClusterNetworkCIDR", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ClusterNetworkCIDR = string(data[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipGenerated(data[iNdEx:])
...
var fileDescriptorGenerated = []byte{
	...
	,
}
